...
-- 
-- This file contains the complete database structure for the NIT GOA
-- faculty management system, including:
-- - Faculty profiles and detailed information
-- - Technical and administrative staff
-- - Publications, research guidance, projects
-- - User authentication system
-- 
-- Usage:
-- mysql -u root -p nitgoa_db < current_database_schema.sql
-- 
-- ==================================================================

-- MySQL dump 10.13  Distrib 8.4.5, for macos15 (arm64)
--
-- Host: localhost    Database: nitgoa_db
-- ------------------------------------------------------
...
--
-- Table structure for table `faculty_academic_info`
--
...
--
-- Table structure for table `faculty_courses_attended`
--
...
--
-- Table structure for table `faculty_courses_conducted`
--
...
--
-- Table structure for table `faculty_funded_projects`
--
...
--
-- Table structure for table `faculty_professional_services`
--
...
--
-- Table structure for table `faculty_research_guidance`
--
...
-- Dump completed on 2025-07-22 15:51:58
