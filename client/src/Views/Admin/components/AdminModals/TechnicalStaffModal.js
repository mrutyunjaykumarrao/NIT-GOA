...
const TechnicalStaffModal = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    is_active: true,
    department_id: '',  // Optional for technical staff
    qualifications: '',
    responsibilities: '',
    office_location: ''
  });
  ...
  const fetchNextEmployeeCode = async () => {
    try {
      console.log('Fetching next employee code for Technical...');
      const response = await fetch('/api/admin/employees/next-code/Technical', {
        headers: {
  ...
  const fetchNextDisplayOrder = async () => {
    try {
      console.log('Fetching next display order for Technical...');
      const response = await fetch('/api/admin/employees/next-display-order/Technical', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const validateForm = () => {
    ...
    // Department is optional for technical staff
    ...
    <div className="admin-modal-overlay">
      <div className="admin-modal admin-modal-large">
        <div className="admin-modal-header">
          <h2>{mode === 'create' ? 'Create New Technical Staff' : 'Edit Technical Staff'}</h2>
            ...
            <div className="admin-form-grid">
              ...
              <div className="admin-form-group">
                ...
                <input
                  ...
                  placeholder="e.g., System Administrator, Lab Technician, IT Support"
                />
              ...
              <div className="admin-form-group admin-form-group-full">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g., Network Administration, Lab Maintenance, IT Support"
                />
              </div>
            </div>
          </div>
            ...
            <div className="admin-form-grid">
              ...
              <div className="admin-form-group">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g., Room 101, Tech Block"
                />
              </div>
            </div>
          </div>
...
export default TechnicalStaffModal;
