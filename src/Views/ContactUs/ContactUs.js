        ...
        <div className="contact-page">
            <div className="contact-container">
                <div className="page-header">
                    <h1>Contact Us</h1>
                    <p className="page-subtitle">Get in Touch with NIT Goa</p>
                </div>

                <div className="contact-content">
                    <section className="contact-section main-contact-section">
                        ...
                        <div className="main-contact-card">
                            <div className="contact-info">
                                ...
                                <div className="contact-details">
                                    <div className="contact-item">
                                        ...
                                        <div>
                                            <strong>Phone:</strong> +91-832-2404200
                                        </div>
                                    </div>
                                    <div className="contact-item">
                                        <span className="contact-icon">📧</span>
                                        <div>
                                            <strong>Email:</strong> registrar@nitgoa.ac.in
                                        </div>
                                    </div>
                                    <div className="contact-item">
                                        <span className="contact-icon">🌐</span>
                                        <div>
                                            <strong>Website:</strong> www.nitgoa.ac.in
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="map-placeholder">
                                <div className="map-content">
                                    <h4>Location Map</h4>
                                    <p>Interactive map showing NIT Goa campus location</p>
                                    <div className="coordinates">
                                        <strong>Coordinates:</strong><br/>
                                        Latitude: 15.1394° N<br/>
                                        Longitude: 74.0269° E
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="contact-section departments-section">
                    ...
                    <section className="contact-section administration-section">
                    ...
                    <section className="contact-section transport-section">
                    ...
                    <section className="contact-section emergency-section">
                    ...
                    <section className="contact-section feedback-section">
                    ...
                    <section className="contact-section social-media-section">
